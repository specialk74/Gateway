...
# Generated by qmake (2.01a) (Qt 4.8.5) on: Sat Dec 7 19:59:57 2013
# Project:  Gateway.pro
# Template: app
...
SOURCES       = main.cpp \
		...
		moc_handlermessage.cpp \
		moc_powermanager.cpp \
		moc_candevice.cpp
OBJECTS       = main.o \
		tcpgateway.o \
		clientoven.o \
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/Gateway1.0.0/ && $(COPY_FILE) --parents tcpgateway.h clientoven.h utils.h abstractdevice.h rs232device.h rs232deviceprivate.h handlermessage.h powermanager.h candevice.h .tmp/Gateway1.0.0/ && $(COPY_FILE) --parents main.cpp tcpgateway.cpp clientoven.cpp utils.cpp abstractdevice.cpp rs232device.cpp rs232deviceprivate.cpp handlermessage.cpp powermanager.cpp candevice.cpp .tmp/Gateway1.0.0/ && (cd `dirname .tmp/Gateway1.0.0` && $(TAR) Gateway1.0.0.tar Gateway1.0.0 && $(COMPRESS) Gateway1.0.0.tar) && $(MOVE) `dirname .tmp/Gateway1.0.0`/Gateway1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/Gateway1.0.0
...
compiler_moc_header_make_all: moc_tcpgateway.cpp moc_clientoven.cpp moc_abstractdevice.cpp moc_rs232device.cpp moc_rs232deviceprivate.cpp moc_handlermessage.cpp moc_powermanager.cpp moc_candevice.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_tcpgateway.cpp moc_clientoven.cpp moc_abstractdevice.cpp moc_rs232device.cpp moc_rs232deviceprivate.cpp moc_handlermessage.cpp moc_powermanager.cpp moc_candevice.cpp
...
moc_handlermessage.cpp: handlermessage.h
	/opt/qt/bin/moc $(DEFINES) $(INCPATH) handlermessage.h -o moc_handlermessage.cpp

moc_powermanager.cpp: powermanager.h
	/opt/qt/bin/moc $(DEFINES) $(INCPATH) powermanager.h -o moc_powermanager.cpp
...
handlermessage.o: handlermessage.cpp abstractdevice.h \
		clientoven.h \
		utils.h \
		handlermessage.h \
		powermanager.h \
		tcpgateway.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o handlermessage.o handlermessage.cpp

powermanager.o: powermanager.cpp utils.h \
		powermanager.h
...
moc_handlermessage.o: moc_handlermessage.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o moc_handlermessage.o moc_handlermessage.cpp

moc_powermanager.o: moc_powermanager.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o moc_powermanager.o moc_powermanager.cpp
